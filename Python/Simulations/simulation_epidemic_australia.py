...
pop_imported_path = '../../../Data/Australia/imported_counts_adjusted.csv'
...
base_interventions.append(cv.clip_edges([56, 70], [0.7, 1], layers='a'))
base_interventions.append(cv.change_beta([56, 70], [0.8, 1], layers='a'))
base_interventions.append(cv.change_beta([70, 88], [0.4, 1], layers='a'))
base_interventions.append(cv.clip_edges([70, 88], [0.4, 1], layers='a'))
